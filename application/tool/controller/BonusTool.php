...
use app\tool\model\Bonus;
use app\tool\model\BonusError;
...
class BonusTool extends BaseTool
{
    ...
    {
        $obj['wxappid'] = Config("config.app_id"); // 公众账号appId
    ...
    public function grant($totalAmount)
    {
        ...
        if ($bonus['return_code'] == "SUCCESS" && $bonus['result_code'] == "SUCCESS") {
            ...
            $BonusError = new BonusError();
            $BonusError->save($data);
